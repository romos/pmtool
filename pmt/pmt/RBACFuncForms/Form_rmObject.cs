...
namespace pmt
{
    public partial class Form_rmObject : Form
    {
        private MainForm mainForm;

        public Form_rmObject()
        {
            InitializeComponent();
        }
        public Form_rmObject(MainForm mf)
        {
            InitializeComponent();
            mainForm = mf;
        }

        private void btn_rmObject_Save_Click(object sender, EventArgs e)
        {
            ...
            status = RBACManager.RmObject(o, mainForm.db);
        ...
        private void Form_rmObject_Load(object sender, EventArgs e)
        {
